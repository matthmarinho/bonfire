...
import NewSessionDrawer from "../../_components/new-session-drawer"
dayjs.locale("pt-br")
...
const AdventurePage = ({ params }: AdventureParamsProps) => {
  ...
  return (
    <>
      ...
      <NewSessionDrawer open={open} setOpen={setOpen} params={params} />
    </>
  )
}
