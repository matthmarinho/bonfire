  ...
  return (
    ...
    >
      <Command
        ...
        className={cn(
          "flex h-auto flex-col overflow-visible border-none bg-transparent",
          className,
        )}
        dir={dir}
        {...props}
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "flex flex-wrap gap-1 rounded-lg border-2 border-border bg-white p-1 py-2",
        {
...
>(({ className, children }, ref) => {
  return (
    <CommandList
      ref={ref}
      className={cn(
        "scrollbar-thin scrollbar-track-transparent scrollbar-thumb-muted-foreground dark:scrollbar-thumb-muted scrollbar-thumb-rounded-lg absolute top-0 z-10 mt-2 flex w-full flex-col gap-2 rounded-md border-2 border-border bg-primary p-2 shadow-md transition-colors",
        className,
      )}
    >
      {children}
